            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="custom-control custom-radio">
                            <input value="barang_stok" type="radio" id="barang_stok" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="barang_stok">Persediaan Barang</label>
                        </div>
