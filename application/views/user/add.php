            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'kabu'); ?> value="kabu" type="radio" id="kabu" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="kabu">kabu</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'pptk'); ?> value="pptk" type="radio" id="pptk" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="pptk">pptk</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'kabid'); ?> value="kabid" type="radio" id="kabid" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="kabid">kabid</label>
                        </div>
                         <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'pegawai'); ?> value="pegawai" type="radio" id="pegawai" name="role" class="custom-control-input">
