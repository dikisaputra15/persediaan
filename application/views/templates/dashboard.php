...
<head>
  ...
  <title><?= $title; ?> | Aplikasi Persediaan Barang</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('user'); ?>">User Management</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('Mintabarang/tabelminta'); ?>">Form Minta Barang</a>
            <a class="collapse-item" href="<?= base_url('Mintabarang/aprove'); ?>">Permintaan Barang</a>
            ...
            <?php } ?>
            <a class="collapse-item" href="<?= base_url('beritaacara'); ?>">Berita Acara</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Astri 2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
