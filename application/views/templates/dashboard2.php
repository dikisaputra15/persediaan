...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
				<a class="nav-link pb-0" href="<?= base_url('Mintabarang/tabelminta'); ?>">
					<i class="fas fa-fw fa-download"></i>
					<span>Form Minta Barang</span>
				</a>
			</li>

			<li class="nav-item">
				<a class="nav-link pb-0" href="<?= base_url('Mintabarang/aprove'); ?>">
					<i class="fas fa-fw fa-download"></i>
			...
			<footer class="sticky-footer bg-light">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; Aplikasi Persediaan Barang 2021 &bull; by astri</span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
